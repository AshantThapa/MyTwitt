package com.ashant.mytwitter.adapter;
...
import android.content.Context;
        ...
        import com.ashant.mytwitter.model.DataSet;

        import java.util.List;

public class DataAdapter extends RecyclerView.Adapter<DataAdapter.InterestName> {

    Context context;
    List<DataSet> dataSetList;

    public DataAdapter(Context context, List<DataSet> dataSetList) {
